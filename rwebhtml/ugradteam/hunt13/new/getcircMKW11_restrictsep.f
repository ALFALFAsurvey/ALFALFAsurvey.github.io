...
C
     ...
     *  XRADEG,RADEG
      ...
      open(17,file='veleither.radec',status='unknown') 
      nsamp=0
      ...
      write(*,'('' At cluster dist, 2 Mpc=70arcmin=1.17 deg'')')
      read *,searchradius
...
c
  ...
  101 FORMAT(I6,A1,A8,1x,2I2.2,I3.3,A1,3I2.2,I5,2I4,i6,2x,I5,I3,2x,
     ...
     *  AGCNUMBER,comma,radeg,comma,dec,comma,vopt,comma,sepmin
      if(HIsource.eq.75 .and. v21.gt.0)
     *  write(16,300) 
     *  AGCNUMBER,comma,radeg,comma,dec,comma,v21,comma,sepmin
  300 format(i6,a1,f8.4,a1,f7.4,a1,i5,a1,f8.4)

      if(vopt.gt.0 .or. (v21.gt.0 .and.HISOURCE.eq.75))  then
        ivel=vopt
        if(vopt.eq.0 .and. v21.ne.0) ivel=v21
        write(17,300) 
     *  AGCNUMBER,comma,radeg,comma,dec,comma,ivel,comma,sepmin
      endif
